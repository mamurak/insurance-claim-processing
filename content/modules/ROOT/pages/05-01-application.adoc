...
- In the image section, change the image to `code-server`.
- Note that using this image illustrates the flexibility of the OpenShift AI platform. Not everyone wants to use Jupyter Notebooks for everything.
