...
We will test the response time and the response quality. +
...
. Here we can see that the pipeline consists of two checks:
...
. In the popup, enter Mistral's endpoint URL and click **OK**.
