...
def test_response_quality(inference_url=''):
    ...
    response = infer_with_template(
        input_text, template, inference_url=inference_url
    )
    ...
    assert (similarity > 0.8), "Output is not similar enough to expected output"
